...
const config: CodegenConfig = {
  ...
  documents: [
    "./src/api-github/operations/**/*.graphql",
    "./src/api-github/operations/**/queries/*.graphql",
    "./src/api-github/operations/**/mutations/*.graphql",
  ],
  generates: {
    "./src/api-github/schema/github-schema.ts": {
      plugins: ["typescript"],
      config: {
        skipTypename: false,
        enumsAsTypes: true,
